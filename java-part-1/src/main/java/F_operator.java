...
public class F_operator {
    ...
    public static void operExam2() {
        ...
        System.out.println("후위형 : " + i++); // 6 -> 6 + 1 // 연산되지 않은 이전 값이 들어가고, 연산된 값은 그 다음 라인에 들어간다.
        ...
        int j = 5;
        System.out.println("========== 증감 ==========");
        System.out.println("전위형 : " + --j); // 5 + 1
        System.out.println(j); // 6
        System.out.println("후위형 : " + j--); // 6 -> 6 + 1 // 연산되지 않은 이전 값이 들어가고, 연산된 값은 그 다음 라인에 들어간다.
    ...
    // [문자열 비교]
    // 두 문자열을 비교할 때는 비교 연산자 '=='대신 equals()라는 메서드를 이용해야 한다.
    public static void operExam4() {
        ...
        // &456 -> Hello -> str1 <- &456
        // &789 -> Hello -> str2 <- &789
        // str1 == str2 -> false // 문자열을 비교한게 아니고 주소를 비교함
